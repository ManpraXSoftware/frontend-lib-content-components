 ...
 */
var ImageSettingsModal = exports.ImageSettingsModal = function ImageSettingsModal(_ref) {
  var close = _ref.close,
    isOpen = _ref.isOpen,
    returnToSelection = _ref.returnToSelection,
    saveToEditor = _ref.saveToEditor,
    selection = _ref.selection,
    intl = _ref.intl;
  var altText = _hooks["default"].altText(selection.altText);
  var dimensions = _hooks["default"].dimensions(altText);
  var onSaveClick = _hooks["default"].onSaveClick({
    altText: altText,
