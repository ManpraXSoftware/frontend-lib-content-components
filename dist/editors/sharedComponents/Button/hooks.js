...
var isVariantAdd = exports.isVariantAdd = function isVariantAdd(variant) {
  return variant === 'add';
};
var getButtonProps = exports.getButtonProps = function getButtonProps(_ref) {
  ...
  var classes = [variantClasses[variant]];
  if (className) {
