...
var mockImageData = exports.mockImageData = [{
...
var mockVideoData = exports.mockVideoData = [{
  displayName: 'shahrukh.jpg',
  contentType: 'image/jpeg',
  dateAdded: 'Jan 05, 2022 at 17:38 UTC',
  url: '/asset-v1:edX+test101+2021_T1+type@asset+block@shahrukh.jpg',
...
var mockBlockIdByType = exports.mockBlockIdByType = function mockBlockIdByType(type) {
  return "".concat(type, "-block-id");
};
