...
var listKeyStore = function listKeyStore(list) {
  return (0, _utils.StrictDict)(list.reduce(function (obj, val) {
    return _objectSpread(_objectSpread({}, obj), {}, _defineProperty({}, val, val));
  }, {}));
};
var commands = exports.commands = (0, _utils.StrictDict)({
  insertContent: 'mceInsertContent'
});
var buttons = exports.buttons = (0, _utils.StrictDict)({
