...
var moduleProps = function moduleProps(propName) {
  return Object.keys(modules).reduce(function (obj, moduleKey) {
    return _objectSpread(_objectSpread({}, obj), {}, _defineProperty({}, moduleKey, modules[moduleKey][propName]));
  }, {});
};
var rootReducer = (0, _redux.combineReducers)(moduleProps('reducer'));
var actions = exports.actions = (0, _utils.StrictDict)(moduleProps('actions'));
var selectors = exports.selectors = (0, _utils.StrictDict)(moduleProps('selectors'));
