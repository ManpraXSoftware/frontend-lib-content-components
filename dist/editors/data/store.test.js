...
jest.mock('redux-thunk', function () {
...
jest.mock('redux', function () {
  return {
    ...
    createStore: function createStore(reducer, middleware) {
      return {
        reducer: reducer,
...
jest.mock('redux-devtools-extension/logOnlyInProduction', function () {
  return {
    composeWithDevTools: function composeWithDevTools(middleware) {
      return {
...
describe('store aggregator module', function () {
  describe('exported store', function () {
    it('is generated by createStore', function () {
      expect(_store["default"]).toEqual((0, _store.createStore)());
    });
    it('creates store with connected reducers', function () {
      expect((0, _store.createStore)().reducer).toEqual(_redux2["default"]);
    });
    describe('middleware', function () {
      it('exports thunk and logger middleware, composed and applied with dev tools', function () {
  ...
  describe('dev exposed tools', function () {
    beforeEach(function () {
      window.store = undefined;
      window.actions = undefined;
      window.selectors = undefined;
    });
    it('exposes redux tools if in development env', function () {
    ...
    it('does not expose redux tools if in production env', function () {
