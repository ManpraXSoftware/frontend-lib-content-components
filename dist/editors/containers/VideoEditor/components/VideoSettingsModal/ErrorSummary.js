...
var hasNoError = exports.hasNoError = function hasNoError(error) {
  return Object.keys(error[0]).length === 0;
};
var showAlert = exports.showAlert = function showAlert(errors) {
  return !Object.values(errors).every(_module.hasNoError);
};
var ErrorSummary = exports.ErrorSummary = function ErrorSummary() {
  var errors = _react["default"].useContext(_hooks.ErrorContext);
