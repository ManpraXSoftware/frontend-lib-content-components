...
var DurationWidget = exports.DurationWidget = function DurationWidget(_ref) {
  var duration = _ref.duration,
    ...
    intl = _ref.intl;
  var _hooks$durationWidget = _hooks["default"].durationWidget({
      duration: duration,
      updateField: updateField
    }),
    unsavedDuration = _hooks$durationWidget.unsavedDuration,
    onBlur = _hooks$durationWidget.onBlur,
    onChange = _hooks$durationWidget.onChange,
    onKeyDown = _hooks$durationWidget.onKeyDown,
    getTotalLabel = _hooks$durationWidget.getTotalLabel;
  var timeKeys = (0, _utils.keyStore)(duration);
