...
var hooks = exports.hooks = {
  replaceFileCallback: function replaceFileCallback(_ref) {
...
var TranscriptActionMenu = exports.TranscriptActionMenu = function TranscriptActionMenu(_ref2) {
  var index = _ref2.index,
    language = _ref2.language,
    launchDeleteConfirmation = _ref2.launchDeleteConfirmation,
    getTranscriptDownloadUrl = _ref2.getTranscriptDownloadUrl;
  ...
  var downloadLink = getTranscriptDownloadUrl({
    language: language
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_paragon.Dropdown, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Dropdown.Toggle, {
      ...
      }, "transcript-actions-".concat(index, "-replace")), /*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Dropdown.Item, {
        href: downloadLink,
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_i18n.FormattedMessage, _objectSpread({}, _messages["default"].downloadTranscript))
      }, "transcript-actions-".concat(index, "-download")), /*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Dropdown.Item, {
      ...
      }, "transcript-actions-".concat(index, "-delete"))]
