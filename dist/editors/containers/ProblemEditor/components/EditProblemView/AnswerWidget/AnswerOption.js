...
var AnswerOption = exports.AnswerOption = function AnswerOption(_ref) {
  var answer = _ref.answer,
    hasSingleAnswer = _ref.hasSingleAnswer,
    intl = _ref.intl,
    problemType = _ref.problemType;
  var dispatch = (0, _reactRedux.useDispatch)();
  var removeAnswer = hooks.removeAnswer({
    answer: answer,
    dispatch: dispatch
  });
  var setAnswer = hooks.setAnswer({
    answer: answer,
    hasSingleAnswer: hasSingleAnswer,
    dispatch: dispatch
  });
  var setAnswerTitle = hooks.setAnswerTitle({
    answer: answer,
    hasSingleAnswer: hasSingleAnswer,
    dispatch: dispatch,
    problemType: problemType
  });
  var setSelectedFeedback = hooks.setSelectedFeedback({
    answer: answer,
    hasSingleAnswer: hasSingleAnswer,
    dispatch: dispatch
  });
  var setUnselectedFeedback = hooks.setUnselectedFeedback({
    answer: answer,
    hasSingleAnswer: hasSingleAnswer,
    dispatch: dispatch
  });
  var _hooks$useFeedback = hooks.useFeedback(answer),
    isFeedbackVisible = _hooks$useFeedback.isFeedbackVisible,
    toggleFeedback = _hooks$useFeedback.toggleFeedback;
  var getInputArea = function getInputArea() {
