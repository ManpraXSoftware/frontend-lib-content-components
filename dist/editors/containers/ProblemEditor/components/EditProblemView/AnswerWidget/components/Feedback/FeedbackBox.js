...
var FeedbackBox = exports.FeedbackBox = function FeedbackBox(_ref) {
  var answer = _ref.answer,
    problemType = _ref.problemType,
    setSelectedFeedback = _ref.setSelectedFeedback,
    setUnselectedFeedback = _ref.setUnselectedFeedback,
    intl = _ref.intl;
  var props = {
    answer: answer,
    intl: intl
  ...
  return problemType === _problem.ProblemTypeKeys.MULTISELECT ? /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_FeedbackControl["default"], _objectSpread({
      ...
      type: "selected"
    }, props), "selectedfeedback-".concat(answer.id)), /*#__PURE__*/(0, _jsxRuntime.jsx)(_FeedbackControl["default"], _objectSpread({
      ...
      type: "unselected"
    }, props), "unselectedfeedback-".concat(answer.id))]
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_FeedbackControl["default"], _objectSpread({
      ...
      onChange: setSelectedFeedback,
      type: "selected"
    }, props), "selectedfeedback-".concat(answer.id))
  });
};
