...
var FeedbackControl = function FeedbackControl(_ref) {
  var feedback = _ref.feedback,
    onChange = _ref.onChange,
    labelMessage = _ref.labelMessage,
    labelMessageBoldUnderline = _ref.labelMessageBoldUnderline,
    answer = _ref.answer,
    intl = _ref.intl,
    type = _ref.type;
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_paragon.Form.Group, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Form.Label, {
      ...
      id: "".concat(type, "Feedback-").concat(answer.id),
      value: feedback,
      setContent: onChange,
