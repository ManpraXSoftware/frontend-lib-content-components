...
var _excluded = ["title", "className", "extraSections", "children", "summary", "hasExpandableTextArea"];
...
var SettingsOption = exports.SettingsOption = function SettingsOption(_ref) {
  var title = _ref.title,
    className = _ref.className,
    extraSections = _ref.extraSections,
    children = _ref.children,
    summary = _ref.summary,
    hasExpandableTextArea = _ref.hasExpandableTextArea,
    passThroughProps = _objectWithoutProperties(_ref, _excluded);
  var _showFullCard = (0, _hooks.showFullCard)(hasExpandableTextArea),
    isCardCollapsibleOpen = _showFullCard.isCardCollapsibleOpen,
    toggleCardCollapse = _showFullCard.toggleCardCollapse;
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_paragon.Card, {
    className: "".concat(className, " settingsOption border border-light-700 shadow-none"),
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Card.Section, {
    ...
    }, "settingsOption-".concat(title, "-header")), /*#__PURE__*/(0, _react.createElement)(_CardSection["default"], _objectSpread(_objectSpread({}, passThroughProps), {}, {
      isCardCollapsibleOpen: isCardCollapsibleOpen,
      summary: summary,
      key: "settingsOption-".concat(title, "-children")
    }), children), extraSections.map(function (section, index) {
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
        children: [isCardCollapsibleOpen && /*#__PURE__*/(0, _jsxRuntime.jsx)("hr", {}), /*#__PURE__*/(0, _react.createElement)(_CardSection["default"], _objectSpread(_objectSpread({}, passThroughProps), {}, {
          isCardCollapsibleOpen: isCardCollapsibleOpen,
          key: "settingsOption-".concat(title, "-").concat(index)
        }), section.children)]
      });
    })]
  });
