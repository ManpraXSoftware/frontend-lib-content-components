...
var ResetCard = exports.ResetCard = function ResetCard(_ref) {
  var showResetButton = _ref.showResetButton,
    updateSettings = _ref.updateSettings,
    intl = _ref.intl;
  var _resetCardHooks = (0, _hooks.resetCardHooks)(updateSettings),
    setResetTrue = _resetCardHooks.setResetTrue,
    setResetFalse = _resetCardHooks.setResetFalse;
  var advancedSettingsLink = "".concat((0, _reactRedux.useSelector)(_redux.selectors.app.studioEndpointUrl), "/settings/advanced/").concat((0, _reactRedux.useSelector)(_redux.selectors.app.learningContextId), "#show_reset_button");
