...
var GroupFeedbackCard = exports.GroupFeedbackCard = function GroupFeedbackCard(_ref) {
  var groupFeedbacks = _ref.groupFeedbacks,
    updateSettings = _ref.updateSettings,
    answers = _ref.answers,
    intl = _ref.intl;
  var _groupFeedbackCardHoo = (0, _hooks.groupFeedbackCardHooks)(groupFeedbacks, updateSettings, answers),
    summary = _groupFeedbackCardHoo.summary,
    handleAdd = _groupFeedbackCardHoo.handleAdd;
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_SettingsOption["default"], {
    ...
    }), groupFeedbacks.map(function (groupFeedback) {
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_GroupFeedbackRow["default"], _objectSpread({
        id: groupFeedback.id,
        value: groupFeedback,
        answers: answers
