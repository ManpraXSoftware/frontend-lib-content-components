...
var HintsCard = exports.HintsCard = function HintsCard(_ref) {
  var hints = _ref.hints,
    problemType = _ref.problemType,
    updateSettings = _ref.updateSettings,
    intl = _ref.intl;
  var _hintsCardHooks = (0, _hooks.hintsCardHooks)(hints, updateSettings),
    summary = _hintsCardHooks.summary,
    handleAdd = _hintsCardHooks.handleAdd;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_SettingsOption["default"], {
    ...
    children: [hints.map(function (hint) {
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_HintRow["default"], _objectSpread({
        id: hint.id,
        value: hint.value
      }, (0, _hooks.hintsRowHooks)(hint.id, hints, updateSettings)), hint.id);
