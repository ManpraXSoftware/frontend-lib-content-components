...
describe('groupFeedbackCardHooks', function () {
  var output;
  var updateSettings;
  var groupFeedbacks;
  beforeEach(function () {
  ...
  describe('Show advanced settings', function () {
    ...
    test('test Event adds a new feedback ', function () {
      output.handleAdd();
...
describe('groupFeedbackRowHooks', function () {
  var mockId = 'iD';
  var mockAnswer = 'moCkAnsweR';
  var mockFeedback = 'mOckFEEdback';
  var groupFeedbacks;
  var output;
  var updateSettings;
  beforeEach(function () {
  ...
  describe('Show advanced settings', function () {
    ...
    test('test associate an answer with the feedback object', function () {
      var mockNewAnswer = 'nEw VAluE';
    ...
    test('test unassociate an answer with the feedback object', function () {
      output.handleAnswersSelectedChange({
        target: {
          checked: false,
          value: mockAnswer
    ...
    test('test update feedback text with a groupfeedback', function () {
      var mockNewFeedback = 'nEw fEedBack';
    ...
    test('Delete a Row from the list of feedbacks', function () {
      output.handleDelete();
      expect(updateSettings).toHaveBeenCalledWith({
        groupFeedbackList: []
      });
