...
var useRandomizationSettingStatus = exports.useRandomizationSettingStatus = function useRandomizationSettingStatus(_ref) {
  var randomization = _ref.randomization,
    updateSettings = _ref.updateSettings;
  var _module$state$summary = _module.state.summary({
      message: _messages["default"].noRandomizationSummary,
      values: {}
    }),
  ...
  (0, _react.useEffect)(function () {
    setSummary({
      message: randomization ? _problem.RandomizationTypes[randomization] : _messages["default"].noRandomizationSummary
    });
  }, [randomization]);
