...
var ProblemTypeSelect = exports.ProblemTypeSelect = function ProblemTypeSelect(_ref) {
  ...
  var handleClick = function handleClick() {
    return setSelected(_problem.AdvanceProblemKeys.BLANK);
  };
  var settings = {
    'aria-label': 'checkbox',
    type: 'radio'
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_paragon.Container, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.SelectableBox.Set, {
      ...
      type: settings.type,
      value: selected,
      children: Object.values(_problem.ProblemTypeKeys).map(function (key) {
        return key !== 'advanced' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.SelectableBox, _objectSpread(_objectSpread({
