...
var EditorContainer = exports.EditorContainer = function EditorContainer(_ref) {
  ...
  var isInitialized = hooks.isInitialized();
  var _hooks$cancelConfirmM = hooks.cancelConfirmModalToggle(),
    isCancelConfirmOpen = _hooks$cancelConfirmM.isCancelConfirmOpen,
    openCancelConfirmModal = _hooks$cancelConfirmM.openCancelConfirmModal,
    closeCancelConfirmModal = _hooks$cancelConfirmM.closeCancelConfirmModal;
  var handleCancel = hooks.handleCancel({
    onClose: onClose
  });
